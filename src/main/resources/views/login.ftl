...
<head>
    ...
    <style>
        ...
        .login-main .login-bottom .center .item .icon-1 {background:url(${ctx}/lib/layuimini-2/images/icon-login.png) no-repeat 1px 0;}
        .login-main .login-bottom .center .item .icon-2 {background:url(${ctx}/lib/layuimini-2/images/icon-login.png) no-repeat -54px 0;}
        .login-main .login-bottom .center .item .icon-3 {background:url(${ctx}/lib/layuimini-2/images/icon-login.png) no-repeat -106px 0;}
        .login-main .login-bottom .center .item .icon-4 {background:url(${ctx}/lib/layuimini-2/images/icon-login.png) no-repeat 0 -43px;position:absolute;right:-10px;cursor:pointer;}
        .login-main .login-bottom .center .item .icon-5 {background:url(${ctx}/lib/layuimini-2/images/icon-login.png) no-repeat -55px -43px;}
        .login-main .login-bottom .center .item .icon-6 {background:url(${ctx}/lib/layuimini-2/images/icon-login.png) no-repeat 0 -93px;position:absolute;right:-10px;margin-top:8px;cursor:pointer;}
        ...
        .login-main .login-bottom .tip .icon-check {margin:0 7px 0 0;width:14px;height:14px;border:none;background:url(${ctx}/lib/layuimini-2/images/icon-login.png) no-repeat -111px -48px;}
        ...
        body {background:url(${ctx}/lib/layuimini-2/images/loginbg.png) 0% 0% / cover no-repeat;position:static;font-size:12px;}
        ...
        <form class="layui-form login-bottom">
            <div class="center">
                ...
                <div id="validatePanel" class="item" style="width: 137px;">
                    ...
                    <img id="refreshCaptcha" class="validateImg"  src="${ctx}/lib/layuimini-2/images/captcha.jpg" >
                </div>
